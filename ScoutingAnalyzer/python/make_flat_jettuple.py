...
for i in range(nevts):
    ...
    ak8_mtrim_0[0] = data_chain.fj_ak8_trimmed_mass[0]
    ak8_mprune_0[0] = data_chain.fj_ak8_pruned_mass[0]
    ak8_msd_0[0] = data_chain.fj_ak8_sd_mass[0]

    ak8_pt_1[0] = data_chain.fj_ak8_pt[1]
    ak8_eta_1[0] = data_chain.fj_ak8_eta[1]
    ak8_phi_1[0] = data_chain.fj_ak8_phi[1]
    ak8_m_1[0] = data_chain.fj_ak8_m[1]
    ak8_mtrim_1[0] = data_chain.fj_ak8_trimmed_mass[1]
    ak8_mprune_1[0] = data_chain.fj_ak8_pruned_mass[1]
    ak8_msd_1[0] = data_chain.fj_ak8_sd_mass[1]


    tau1_0[0] = data_chain.fj_ak8_tau1[0]
    tau2_0[0] = data_chain.fj_ak8_tau2[0]
    tau3_0[0] = data_chain.fj_ak8_tau3[0]
    tau4_0[0] = data_chain.fj_ak8_tau4[0]
    
    tau1_1[0] = data_chain.fj_ak8_tau1[1]
    tau2_1[0] = data_chain.fj_ak8_tau2[1]
    tau3_1[0] = data_chain.fj_ak8_tau3[1]
    tau4_1[0] = data_chain.fj_ak8_tau4[1]
